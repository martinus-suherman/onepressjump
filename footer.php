...
?>
    <footer id="colophon" class="site-footer" role="contentinfo">
        ...
        <div class="site-info">
            ...
            <a href="https://www.w3-edge.com/products/" rel="external">Optimization WordPress Plugins &amp; Solutions by W3 EDGE</a>
        </div>
        <!-- .site-info -->
...
if (window.performance) 
{
  ...
  ga('send', 'timing', 'Page Load', 'page-load', timeSincePageLoad);
}
</script>
</body>
</html>
