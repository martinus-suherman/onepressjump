...
if ( ( ! $disable && ( $video || $heading ) )  || onepress_is_selective_refresh() ) {
    ...
    ?>
    <?php if ( $image ) { ?>
    <div id="parallax-<?php echo esc_attr( $id ); ?>" class="section-padding parallax-<?php echo esc_attr( $id ); ?> parallax-window" data-over-scroll-fix="true" data-z-index="1" data-speed="0.3" data-image-src="<?php echo esc_url( $image ); ?>" data-parallax="scroll" data-position="center" data-bleed="0">
    <?php } ?>
